 ...
 *
 * This version of PI Counter uses a class from the Java Collections framework, in this case, ArrayList. It has
 * different behavior whether running synchronized or un-synchronized. In synchronized, all threads will modify a static
 * storage class. In un-synchronized, each will modify their own storage class.
 * See CounterThread.java for more information to our thread class.
 *
...
public class NumberCounter  {
    ...
    static ArrayList<Integer> count; // class from Java Collections framework. This will be used in synchronized.
    ...
    public void assignThreads() {
        ...
        for(int index = 0; index < numThreads; index++) {
            ...
            threads[index] = new CounterThread(file, index * perThread, width, sync);
    ...
    public void printTotal(){
        ...
        for(CounterThread thread : threads) {
            ...
            ArrayList<Integer> fromThread = thread.getCount();
